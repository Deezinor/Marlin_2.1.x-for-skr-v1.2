...
// @section bltouch
  ...
  #define BLTOUCH_FORCE_SW_MODE //JMB
...
#define INPUT_SHAPING_Y //JMB
  ...
  #define SHAPING_MENU                // Add a menu to the LCD to set shaping parameters. //JMB
#endif
 ...
 */
   ...
   */
  #define HYBRID_THRESHOLD //JMB

  #define X_HYBRID_THRESHOLD     150  // [mm/s] //JMB
  #define X2_HYBRID_THRESHOLD    150            //JMB
  #define Y_HYBRID_THRESHOLD     150            //JMB
  #define Y2_HYBRID_THRESHOLD    150            //JMB
